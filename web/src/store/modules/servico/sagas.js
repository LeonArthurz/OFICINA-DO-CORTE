...
// FUNÇÃO PARA ADICIONAR O SERVICO
...
// FUNÇÃO PARA MUDAR STATUS COLABORADORSERVICO 'E'
export function* removeServico() {
    ...
    try {
        ...
        yield put(allServicosAction());
        yield put(updateServico({ components: {...components, drawer: false, confirmeDelete: false }}));
        yield put(resetServico());
...
// FUNÇÃO P/ EXCLUIR ARQUIVOS DA AWS
